  ...
  return (
    <Box className="MyStats" direction="vertical">
      ...
      <Label as="p" size="small" color="grey400">
        In Round 2, scores are counted based on total origination fees
        generated. Origination fee is the fee paid by members at the time they
        borrow. Scoring accounts for both origination fee generated by a user
        through borrowing as well as the origination fee generated from
        borrowers they are vouching for.
      </Label>
    </Box>
  );
}
